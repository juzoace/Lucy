...
function callToAction() {
    ...
    return (
        <div className="bg-purple-100 w-full pt-[150px] mb-[120px]"> 
            ...
            <a href={data.callToActionButton.href}>
                <CallToActionButton width={data.callToActionButton.width} />
            </a>   
            </div>
            <div className='flex flex-row items-center justify-center'>
               {width! >= 760 ? <Image width={1280} height={800} src={CallToActionImage}/> : <Image src={CallToActionImageMobile}/>}
            </div>
        </div>
    )
}
